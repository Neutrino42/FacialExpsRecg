...
face_cascade = cv2.CascadeClassifier(r'E:\Python3.6\Lib\site-packages\cv2\data\haarcascade_frontalface_default.xml')
...
# eye_cascade.load(r'E:\Python3.6\Lib\site-packages\cv2\data\haarcascade_eye.xml')
